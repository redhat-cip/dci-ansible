...
def main():
    ...
    elif module.params['id'] and not module.params['name'] and not module.params['label'] and not module.params['component_types'] and not module.params['product_id'] and not module.params['members']:
        kwargs = {}
    ...
    elif module.params['id'] and module.params['members']:

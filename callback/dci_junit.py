...
DOCUMENTATION = '''
    ...
    options:
      ...
      include_setup:
        ...
        env:
          - name: JUNIT_INCLUDE_SETUP_IN_REPORT
    requirements:
...
class CallbackModule(CallbackBase):
    ...
    This plugin makes use of the following environment variables:
        ...
        JUNIT_FAIL_ON_IGNORE (optional): Consider failed tasks as a junit test failure even if ignore_on_error is set
                                     Default: False
        JUNIT_INCLUDE_SETUP_IN_REPORT (optional): Should the setup tasks be included in the final report
                                     Default: True
    ...
    def __init__(self):
        ...
        self._include_setup_in_report = os.getenv('JUNIT_INCLUDE_SETUP_IN_REPORT', 'True').lower()
    ...
    def _generate_report(self):
        ...
        for task_uuid, task_data in self._task_data.items():
            if task_data.action == 'setup' and self._include_setup_in_report == 'false':
                continue
